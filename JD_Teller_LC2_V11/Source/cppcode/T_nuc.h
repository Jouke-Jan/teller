...
//#define CUT_NAME_AT_PIPE  // slurry

#define COMPILER_VERSION   59  // muss grösser gleich 30 sein !!! don't forget about comment in class _Lse
#define _LSE_VERSION   0x115F
...
#define  VARNO_SHIFTFLAG   0xFFFFFFFBL
#define  VARNO_INSERTFLAG  0xFFFFFFFAL
...
class _Sequencer
{
  ...
  public :
    ...
    void      Free(void);
    _BOOL     Load(_ASCII*);
    _BOOL     Call(_UWORD, _BOOL);
    _BOOL     CallCompiler(_COMPCODE*, _BOOL);
...
class _Scheme
{
  protected :
    ...
    _BOOL          CallSub(_UDWORD*, _MEM_SINGLESCHEME*, _VARLABEL*);
  ...
  public :
    ...
    _BOOL          Call(_UDWORD*, _MYSCHEME*, _VARLABEL*, _UDWORD);
    _BOOL          Call(_UDWORD*, _LINKSCHEME*, _UDWORD);
...
//#define STATICSTACKSIZE 64
//typedef struct { _UWORD       sno;
//                 _STACK_LINE  stackline[STATICSTACKSIZE];
//               }
//_STATICSTACK;
...
{
  private :
    _UWORD          SwapLanguageNo;
    _BOOL           MemTextPufferIndex;
    _MEM_TextPuffer MemTextPuffer[2];
    _BOOL           Unicode;
  ...
  public :
    ...
    _UWORD      GetNo(void);
	  _BOOL       SwapLanguage(_BOOL, _UWORD);
...
//    _BOOL  WriteIntern(_UBYTE*, _UDWORD);
...
//    _BOOL  Open(_FILE_STATE, _ASCII*, _ASCII*, _ASCII*, _ASCII*); // file open
    ...
    _BOOL  Read_HEADER(_UDWORD*, const _ASCII*);
...
//    _BOOL  Read_VTX(_File*, _UWORD);                      // load vartextlist
    ...
    _BOOL  GetValueIntern(_RESULT*, _VARIABLE*, _VARLABEL*, _BOOL, _BOOL);// get data
   #ifdef UC_GLOBAL_VAR
...
//    _BOOL   Load_VTX(_ASCII*, _UWORD);                   // load vartextlist
    ...
    _BOOL   GetSystemData(_RESULT*, _VARIABLE*, _VARLABEL*, _BOOL, _BOOL); // get value
...
//    _UDWORD FindIndexLasalID(_UDWORD, _DWORD, _DWORD);
    ...
    _BOOL   GetMinMax(_RESULT*, _VARIABLE*, _VARLABEL*, _BOOL);// get min and max value
    ...
    _BOOL   GetValue(_VARLABEL*, _IVALUE*, _BOOL);        // get singlevalue
...
class _Project
{
  private :
    ...
    _BOOL  GetPictureAccessSub(_ASCII*, _UWORD*, _BOOL, _PRJ_ENTRY**);
...
//		void   Out_CIRCLE(_CIRCLE*, _DOT*, _ZOOM*);
   ...
   #endif
    _BOOL  Refresh_CAROUSEL(_UWORD actno, _MOTION *p, _DOT *offset, _ZOOM *zoom, _BOOL init, _Picture *Ppic);
...
class _Picture
{
  ...
  public :
    ...
    void  Refresh(_DOT*);                                      // just refresh
...
//    void  StartIntern(_BOOL);
    void  ReadyIntern(_BOOL);
    void  RunIntern(_Window*, _EVENT*, _DOT*);
...
extern _UDWORD       GlobalChangeIrq;
...
extern _BOOL   get_global(void*, _VARINFO*);
#endif
#ifdef UC_NEW_ALARMSYSTEM
...
extern "C" void    ReadPixelStart(void);
...
extern "C" _BOOL overload_PICTUREMASK(_PICTUREMASK*, _VARLABEL*);
...
extern "C" _BOOL  add_key(_MY_PICTURE *mp, _STYLESHEET *pstyle, _ROOM *pr, _UDWORD imageno, void *text, _UWORD chrsize, _ATTRIB imagealign, _UWORD keycode, _UWORD keycode_shift, _UWORD keycode_altgr=_NOKEY);
...
extern     void   level_triangle(_ROOM *pr, _UWORD dir, _COLOR color);
...
extern     _DOIT  getfocus_SLIDER(_EDITOR *pedi);
...
// T_SYS.CPP ****************************************************************
extern "C" _UDWORD SwapZero32(_UDWORD *address);
...
extern     _UDWORD add_TEXT_BUFFER(_TEXT_BUFFER*, void*, _UWORD);
...
extern     _DOIT   getfocus_THEURGE(_EDITOR*);
...
extern     void    found_something_by_hid(_FOUNDHID);
