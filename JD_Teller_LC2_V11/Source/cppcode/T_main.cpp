...
_BOOL RTK_Run(void)
{
 ...
 #ifdef _CHANGELOOKUP
  GlobalChangeSys = SwapZero32(&GlobalChangeIrq);
// #ifdef _MSC_VER
//  __asm pushf
//  __asm cli
//  GlobalChangeSys = GlobalChangeIrq;
//  GlobalChangeIrq = 0;
//  __asm popf
// #endif
//
...
//  SYSMAE_MetaEvent();                             // do events for op-system
//  HF310306: Anweisung OPSys: Funktion nicht benötigt - wird bei _Grafik::GetEventEx _Grafik::GetEvent intern aufgerufen
