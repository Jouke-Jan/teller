...
//os version where copy bug of ARM platforms is corrected
#define VM_COPY_BUG_CORRECTED  		    16#9164		// OS Version 09.01.100
...
#define VM_CMD_INSERT_DO_TO_DOL           16#8020 // insert data object into a data object list or only into memory for this list (if only in memory it can be linked to the list via VM_CMD_LINK_DO_TO_DOL)
#define VM_CMD_LINK_DO_TO_DOL             16#8021 // link an existing data object into a data object list
#define VM_CMD_DO_CREATION_FINISHED       16#8022 // a post init object tells the varan manager it has finished DO creation
#define VM_CMD_DO_MEM_READY               16#8023 // a post init object asks the varan manager if all post init objects have finished DO creation
#define VM_CMD_MOVE_DO_CREATION_FINISHED  16#8024 // a post init object tells the varan manager it has finished Move DO creation
#define VM_CMD_MOVE_DO_MEM_READY          16#8025 // a post init object asks the varan manager if all post init objects have finished Move DO creation
